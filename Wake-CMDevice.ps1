...
PARAM(
    ...
    if( $QueryDNS.IsPresent ) {
        ...
        Try {
            ...
            $DHCPServerNames = Get-DhcpServerInDC | Select-Object -ExpandProperty DnsName
            ...
            foreach ( $server in $DHCPServerNames ) {
                ...
                Try {
                    ...
                    $mac = Get-DhcpServerv4Lease -ComputerName $server -IPAddress $ip -ErrorAction SilentlyContinue | Select-Object -ExpandProperty ClientId
                    ...
                    if ($mac) {
                        ...
                        ###If we found a valid ClientID, break out of the foreach loop
                        break
                        ...
                        Write-Verbose "A lease for IP: $ip could not be found on $server."
